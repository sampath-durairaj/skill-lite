/* Skill-Lite — Languages (Python) Tutorial Navigation */

(function () {
  var SECTIONS = [
    { label: 'Getting Started', pages: [
      { file: 'introduction.html', icon: '🐍', title: 'Introduction to Python' },
      { file: 'basics.html',       icon: '📘', title: 'Python Basics' }
    ]},
    { label: 'Data & Arrays', pages: [
      { file: 'numpy.html', icon: '🔢', title: 'NumPy' }
    ]},
    { label: 'Data Analysis', pages: [
      { file: 'pandas.html', icon: '🐼', title: 'Pandas' }
    ]},
    { label: 'Visualization', pages: [
      { file: 'matplotlib.html', icon: '📊', title: 'Matplotlib' }
    ]},
  ...
  function isTutorialPage() {
    ...
    return dir === 'python' && PAGES.some(function (p) { return p.file === file; });
  }
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    /* ── 1. Top-menu "Languages" dropdown ── */
    var dropdown = document.getElementById('languagesDropdown');
    if (dropdown) {
    ...
    if (side && onTutorial) {
      var sHtml = '<div class="side-title"><span class="python-logo">🐍</span>Python Tutorial</div>';
