/* Skill-Lite — Math for ML Tutorial Navigation */
...
(function () {
  var SECTIONS = [
    ...
    { label: 'Linear Algebra', pages: [
      { file: 'linear-algebra.html', icon: '🔢', title: 'Linear Algebra' }
    ]},
    { label: 'Probability & Statistics', pages: [
      { file: 'probability-statistics.html', icon: '🎲', title: 'Probability & Statistics' }
    ]},
    { label: 'Calculus', pages: [
      { file: 'calculus.html', icon: '📉', title: 'Calculus' }
    ]},
  ...
  function isTutorialPage() {
    ...
    return dir === 'math-for-ml' && PAGES.some(function (p) { return p.file === file; });
  }
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    /* ── 1. Top-menu "Math for ML" dropdown ── */
    var dropdown = document.getElementById('mathmlDropdown');
    if (dropdown) {
    ...
    if (side && onTutorial) {
      var sHtml = '<div class="side-title"><span class="mathml-logo">🧮</span>Math for ML</div>';
